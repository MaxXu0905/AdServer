...
@Entity
@Table(name = "his_user")
public class HisUser implements Serializable, Cloneable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((changeName == null) ? 0 : changeName.hashCode());
	...
	@Override
	public HisUser clone() {
		try {
			return (HisUser) super.clone();
